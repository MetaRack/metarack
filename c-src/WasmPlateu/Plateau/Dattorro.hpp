...
public:
    ...
    double get_IN_L() const { return leftInput; }
    double get_IN_R() const { return rightInput; }
    void set_IN_L(double l) { leftInput = l; }
    void set_IN_R(double r) { rightInput = r; }

    double get_OUT_L() const { return leftOut; }
    double get_OUT_R() const { return rightOut; }
    void set_OUT_L(double l) { leftOut = l; }
    void set_OUT_R(double r) { rightOut = r; }
