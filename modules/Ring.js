class Ring extends Module {
	constructor () {
		...
		this.add_input(new Port({x:hp2px(0.8), y:8, r:6, name:'IN1'}));
		this.add_input(new Port({x:hp2px(0.8), y:28, r:6, name:'IN2'}));
		this.add_input(new InputEncoder({x:hp2px(0.6), y:46, r:7, vmin:-1, vmax:1, val:0, name:'POL'}));
		this.add_input(new InputEncoder({x:hp2px(0.6), y:66, r:7, vmin:0, vmax:1, val:1, name:'D/W'}));
