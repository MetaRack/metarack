class Offset extends Module {
	constructor() {
    super({name:'Offset', w:hp2px(4)});

    this.add_input(new Port({x:hp2px(0.8), y:88, r:6, name:'IN'}));
    this.add_output(new Port({x:hp2px(0.8), y:108, r:6, name:'OUT'}));
    this.add_input(new InputEncoder({x:hp2px(0.6), y:6, r:7, vmin:-10, vmax:10, val:0, name:'OFST'}));
    this.add_input(new InputEncoder({x:hp2px(0.6), y:26, r:7, vmin:0, vmax:3, val:1, name:'SCL'}));
