class ByteBeat extends Module {
  ...
  constructor() {
    ...
    this.add_input(new InputEncoder({x:hp2x(0.6), y:26, r:7, vmin:0, vmax:10, val:0, name:'P2'}));
    this.add_input(new InputEncoder({x:hp2x(3.6), y:6, r:7, vmin:0, vmax:10, val:0, name:'P3'}));
    this.add_input(new InputEncoder({x:hp2x(3.6), y:26, r:7, vmin:0, vmax:10, val:0, name:'P4'}));
    this.add_input(new InputEncoder({x:hp2x(0.6), y:46, r:7, vmin:1, vmax:4, val:2, precision:0, name:'CLDV'}));
    this.add_input(new InputEncoder({x:hp2x(3.6), y:46, r:7, vmin:1, vmax:10, val:1, precision:0, name:'VLDV'}));
    this.add_output(new Port({x:hp2x(0.8), y:108, r:6, name:'CLK'}));
